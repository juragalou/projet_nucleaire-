...
def reactorModel(fuelCompo, FPCompo, t_final, n_th_init, n_fa_init, mTot):
    ...
    for i in range(len(time)-1) :
        ...
        n_fis_th = U235_fis_th + U239_fis_th + Pu239_fis_th + Pu241_fis_th
        n_cap_th = U235_cap_th + U236_cap_th + U237_cap_th + U238_cap_th + U239_cap_th + Np239_cap_th + Pu239_cap_th + Pu240_cap_th + Pu241_cap_th + Xe135_cap_th
        n_fis_fa = U235_fis_fa + U236_fis_fa + U237_fis_fa + U238_fis_fa + U239_fis_fa + Np239_fis_fa + Pu239_fis_fa + Pu240_fis_fa + Pu241_fis_fa
        n_cap_fa = U236_cap_fa + U237_cap_fa + U238_cap_fa + U239_cap_fa + Np239_cap_fa + Xe135_cap_fa
    ...
    plt.loglog(time,Th232,label="Pu240")
    plt.loglog(time,Th232,label="Pu241")
    plt.loglog(time,Pa233,label='FP*')
    plt.loglog(time,U233,label="Xe135")
